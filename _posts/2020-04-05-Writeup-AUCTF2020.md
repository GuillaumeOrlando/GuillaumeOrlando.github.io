...
Une fonction (encore nomé "_encrypt_") nous bloque l'accès dans le cas ou nous chercherions à lire le flag:
...
En observant linéairement les instructions exécuté depuis le main, il est possible de remarquer que le prgramme commence sa routine par en créant un '[exception handler](https://docs.microsoft.com/en-us/windows/win32/debug/structured-exception-handling)':
